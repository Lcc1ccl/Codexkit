...
final class MenuBarStatusItemIdentityTests: XCTestCase {
    ...
    func testIdentityConstantsStayStable() {
        XCTAssertEqual(MenuBarStatusItemIdentity.accessibilityLabel, "Codexkit")
        XCTAssertEqual(MenuBarStatusItemIdentity.accessibilityIdentifier, "codexkit.status-item")
        XCTAssertEqual(
