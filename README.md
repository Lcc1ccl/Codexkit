...
- Apple Silicon：`codexkit-0.2.1-macOS-arm64.dmg` 或 `.zip`
- Intel Mac：`codexkit-0.2.1-macOS-x86_64.dmg` 或 `.zip`
...
```bash
CODEXKIT_RELEASE_VERSION=0.2.1-local \
...
- `codexkit-0.2.1-macOS-arm64.dmg`
- `codexkit-0.2.1-macOS-arm64.zip`
- `codexkit-0.2.1-macOS-x86_64.dmg`
- `codexkit-0.2.1-macOS-x86_64.zip`
