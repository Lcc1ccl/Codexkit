        ...
        VStack(alignment: .leading, spacing: 14) {
            ...
            HStack {
                Button("Open Browser", action: onOpenBrowser)
                    ...
                    .accessibilityIdentifier("codexkit.oauth.open-browser")
                Button("Copy Link", action: onCopyLink)
                    .buttonStyle(.bordered)
                    .accessibilityLabel("Copy Login Link")
                    .accessibilityIdentifier("codexkit.oauth.copy-link")
            }
            ...
            TextEditor(text: $callbackInput)
                ...
                .accessibilityIdentifier("codexkit.oauth.callback-input")
            ...
            HStack {
                ...
                .accessibilityIdentifier("codexkit.oauth.cancel")
                ...
                .accessibilityIdentifier("codexkit.oauth.complete-login")
            }
        }
        .padding(16)
        .frame(width: 520)
