...
extension Notification.Name {
    static let openAILoginDidSucceed = Notification.Name("lzl.codexkit.openai-login.did-succeed")
    static let openAILoginDidFail = Notification.Name("lzl.codexkit.openai-login.did-fail")
}
...
final class OpenAILoginCoordinator {
    ...
    static let loginURLScheme = "com.codexkit.oauth"
    ...
    private func startCallbackServer() {
        ...
        do {
            ...
            NSLog("Codexkit localhost OAuth callback listener unavailable: %@", error.localizedDescription)
