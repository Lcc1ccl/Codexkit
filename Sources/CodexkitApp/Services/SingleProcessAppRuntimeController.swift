...
final class SingleProcessAppRuntimeController {
    ...
    private let cliProxyAPIRuntime: any LifecycleControlling
    ...
    init(
        ...
        cliProxyAPIRuntime: (any LifecycleControlling)? = nil,
        ...
        self.cliProxyAPIRuntime = cliProxyAPIRuntime ?? CLIProxyAPIRuntimeController.shared
    ...
    static func live() -> SingleProcessAppRuntimeController {
        SingleProcessAppRuntimeController(
            ...
            cliProxyAPIRuntime: CLIProxyAPIRuntimeController.shared,
